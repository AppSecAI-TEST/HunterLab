...
public class SaveAnnotationsCommand extends DisposableAction {

    private TextAnnotationUtil textAnnotationUtil;
    private JTabbedPane tabbedPane;

    public SaveAnnotationsCommand(TextAnnotationUtil textAnnotationUtil, JTabbedPane tabbedPane) {
        super("Save", MechAnICIcons.getIcon(MechAnICIcons.SAVE_ANNOTATIONS_ICON));
