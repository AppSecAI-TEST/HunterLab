...
public interface RefreshAnnotationsDisplayListener extends EventListener {
	 ...
	 *            
	 * @see TextViewer#initialize()
	 * @see KnowtatorManager#refreshAnnotationsDisplay(boolean)
	 */
