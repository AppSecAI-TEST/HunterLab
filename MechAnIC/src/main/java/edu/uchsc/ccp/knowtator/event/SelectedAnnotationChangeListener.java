...
public interface SelectedAnnotationChangeListener extends EventListener {
	/**
	 * To get the currently selected annotation at any time call
	 * KnowtatorManager.getSelectedAnnotation().
	 * 
	 * @see KnowtatorManager#getSelectedAnnotation()
	 */
