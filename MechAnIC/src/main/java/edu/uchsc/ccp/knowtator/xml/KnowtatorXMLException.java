...
public class KnowtatorXMLException extends Exception {
	private static final long serialVersionUID = 621813442L;
	...
	public KnowtatorXMLException(String message, Throwable cause) {
		super(message, cause);
	}
